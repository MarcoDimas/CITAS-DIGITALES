...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="card my-4">
            <div class="card-header">Registrar Subtrámites</div>
            <div class="card-body">
                <form method="POST" action="{{ route('guardarDatosub') }}">
                    @csrf
                      <div class="row">                        
                        <div class="col">
                            <label for="id_dependencia" class="col-form-label"><i class="bi-sm  bi-clipboard-fill"></i> Trámite:</label>
                            <br>
                            <select class="form-control" name="id_tramite" id="select1" onchange="cargarOpciones()" style="width: 330px;  display: block; background-color: #f9f9f9;">
                                   <option disabled>SELECCIONA TRÁMITE</option> 
                        ...
                        <div class="col">
                            <label for="exampleFormControlTextarea1" class="form-label"><i class="bi-sm  bi-clipboard-fill"></i> Descripción Subtrámite</label>
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="1"></textarea>
                        </div>
                      </div>
                      <div class="row">                                                
                        <div class="col">
                            <label for="exampleFormControlTextarea1" class="form-label"><i class="bi-sm  bi-clipboard-fill"></i> Requisitos Subtrámite</label>
                            <textarea class="form-control" id="requisitos" name="requisitos" rows="1"></textarea>
                        </div>
                      </div>
